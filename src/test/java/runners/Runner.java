...
public class Runner {
    ...
    Cucumber'daki Runner class'i icinde hic bir kod yazilmaz
    Gorevi TestNG'deki .xml dosyalari gibi toplu calistirmayi saglamaktir

    Runner class'i gorevini kullanacagimiz notasyonlar ile gerceklestirir
    ...
    sadece o klasoru calistirmasini isteyebilirsiniz (wip)
    (wip'i Constants.FEATURES_PROPERTY_NAME : "src/test/resources/features/wip" seklinde yola da eklemen gerekir)
    (bu alternatif cok verimli olmayabilir)

    2-istediginiz Feature veya Scenario'lari bir tag ile belirleyip
    Constants.FILTER_TAGS_PROPERTY_NAME : "@wip"

    Eger Runner dosyasi ile calistirdigimiz feature dosyalarini
    Sadece eksik stepdefinition'lari bulmak ve method'larini olusturmak icin calistiriyorsak
